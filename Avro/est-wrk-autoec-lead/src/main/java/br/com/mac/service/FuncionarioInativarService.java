...
import br.com.mac.funcionario.exception.InativarFuncionarioException;
...
@Service
public class FuncionarioInativarService {

  private static final Logger logger = LoggerFactory.getLogger(FuncionarioInativarService.class);
  ...
  @Transactional(value = "transactionManagerBlue",
      rollbackFor = InativarFuncionarioException.class)
  public ResponseEntity<ResponseFuncionarioDTO> inativarFuncionario(final Long codigoAtivarInativar,
    ...
    for (Funcionario funcionario : funcionarios) {
      ...
      if (!ObjectUtils.isEmpty(funcionario.getPessoa())) {
        responseDTOS.add(FuncionarioResponseDTO.builder()
            ...
            .cnpj(funcionarioComponente
                .obterCnpjPeloIdFuncionario(Acao.INATIVAR.getCodigo(),
            ...
            .motivo(funcionarioComponente
                .getMotivoFromDTO(Acao.INATIVAR.getCodigo(), requestDto,
                    funcionario.getIdFuncionario()))
            .build());
      }
    }
    ...
    List<Historico> historicos = responseDTOS.stream().map(funcionarioDTO -> Historico.builder()
        ...
        .motivo(MotivoInativar.toEnum(funcionarioDTO.getMotivo()).getDescricao())
        .build())
